...
| ![ESLint Plugin for MUI sx Key Order](./screenshots/eslint-rules.png) | [**ESLint Plugin for MUI sx Key Order**](https://github.com/sytnikovzp/eslint-plugin-mui-sx-order#readme)<br><br>A simple ESLint plugin that ensures Material-UI sx prop keys are sorted according to best practices, improving code consistency and maintainability.<br><br><img src="https://img.shields.io/github/last-commit/sytnikovzp/eslint-plugin-mui-sx-order" alt="Last Commit"> |
