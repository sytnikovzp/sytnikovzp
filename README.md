...
| ![ESLint Plugin for Sorting MUI sx Properties](./screenshots/eslint-mui-sx.png) | [**ESLint Plugin for Sorting MUI sx Properties**](https://www.npmjs.com/package/eslint-plugin-mui-sx-order)<br><br>This ESLint plugin helps maintain the correct order of properties in MUI (Material-UI) `sx` objects according to best practices.<br>Published on [npm](https://www.npmjs.com/package/eslint-plugin-mui-sx-order) <br><br><img src="https://img.shields.io/github/last-commit/sytnikovzp/eslint-plugin-mui-sx-order" alt="Last Commit"> |
